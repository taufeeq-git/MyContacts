...
public interface UserDAO {
	...
	int getUserIdByGoogleId(String uid);

	void setUniqueId(int userId, String uniqueId, String provider);

	boolean doesEmailExist(int userId, String newEmail);

	boolean doesNumberExist(int userId, String newPhoneNumber);
